...
+ (GPBExtensionRegistry*)extensionRegistry {
  ...
  if (!registry) {
    ...
    [registry addExtensions:[ChainRoot extensionRegistry]];
  }
  return registry;
}
...
GPBEnumDescriptor *ChainMessageType_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        ...
        "gerHeader\000ChainContractLog\000ChainLedgerTx"
        "s\000ChainSubscribeTx\000ChainTxEnvStore\000";
    static const int32_t values[] = {
        ...
        ChainMessageType_ChainContractLog,
        ChainMessageType_ChainLedgerTxs,
...
BOOL ChainMessageType_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case ChainMessageType_ChainContractLog:
    case ChainMessageType_ChainLedgerTxs:
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "buchainVersion",
        .dataTypeSpecific.className = NULL,
        .number = Hello_FieldNumber_BuchainVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Hello__storage_, buchainVersion),
        .flags = GPBFieldOptional,
      ...
      },
      {
        .name = "license",
        .dataTypeSpecific.className = NULL,
        .number = Hello_FieldNumber_License,
        .hasIndex = 7,
        .offset = (uint32_t)offsetof(Hello__storage_, license),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
    };
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "chainId",
        .dataTypeSpecific.className = NULL,
        .number = GetLedgers_FieldNumber_ChainId,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(GetLedgers__storage_, chainId),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt64,
      },
    };
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "chainId",
        .dataTypeSpecific.className = NULL,
        .number = Ledgers_FieldNumber_ChainId,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Ledgers__storage_, chainId),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt64,
      },
    };
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "buchainVersion",
        .dataTypeSpecific.className = NULL,
        .number = ChainStatus_FieldNumber_BuchainVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(ChainStatus__storage_, buchainVersion),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
      ...
      },
      {
        .name = "networkId",
        .dataTypeSpecific.className = NULL,
        .number = ChainStatus_FieldNumber_NetworkId,
        .hasIndex = 5,
        .offset = (uint32_t)offsetof(ChainStatus__storage_, networkId),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt64,
      },
    };
...
GPBEnumDescriptor *ChainTxStatus_TxStatus_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    static const int32_t values[] = {
        ...
        ChainTxStatus_TxStatus_ApplyFailure,
    };
    GPBEnumDescriptor *worker =
...
BOOL ChainTxStatus_TxStatus_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case ChainTxStatus_TxStatus_ApplyFailure:
      return YES;
    default:
      return NO;
  }
...
#pragma mark - TransactionEnvResult

@implementation TransactionEnvResult

@dynamic hasTranEnv, tranEnv;
@dynamic txHash;
@dynamic errorCode;
@dynamic errorDesc;

typedef struct TransactionEnvResult__storage_ {
  uint32_t _has_storage_[1];
  ERRORCODE errorCode;
  TransactionEnv *tranEnv;
  NSString *txHash;
  NSString *errorDesc;
} TransactionEnvResult__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = TransactionEnvResult_FieldNumber_TranEnv,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(TransactionEnvResult__storage_, tranEnv),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "txHash",
        .dataTypeSpecific.className = NULL,
        .number = TransactionEnvResult_FieldNumber_TxHash,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(TransactionEnvResult__storage_, txHash),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "errorCode",
        .dataTypeSpecific.enumDescFunc = ERRORCODE_EnumDescriptor,
        .number = TransactionEnvResult_FieldNumber_ErrorCode,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(TransactionEnvResult__storage_, errorCode),
        .flags = GPBFieldOptional | GPBFieldHasEnumDescriptor,
        .dataType = GPBDataTypeEnum,
      },
      {
        .name = "errorDesc",
        .dataTypeSpecific.className = NULL,
        .number = TransactionEnvResult_FieldNumber_ErrorDesc,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(TransactionEnvResult__storage_, errorDesc),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[TransactionEnvResult class]
                                     rootClass:[OverlayRoot class]
                                          file:OverlayRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(TransactionEnvResult__storage_)
                                         flags:0];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
...
int32_t TransactionEnvResult_ErrorCode_RawValue(TransactionEnvResult *message) {
  GPBDescriptor *descriptor = [TransactionEnvResult descriptor];
  GPBFieldDescriptor *field = [descriptor fieldWithNumber:TransactionEnvResult_FieldNumber_ErrorCode];
  return GPBGetMessageInt32Field(message, field);
}

void SetTransactionEnvResult_ErrorCode_RawValue(TransactionEnvResult *message, int32_t value) {
  GPBDescriptor *descriptor = [TransactionEnvResult descriptor];
  GPBFieldDescriptor *field = [descriptor fieldWithNumber:TransactionEnvResult_FieldNumber_ErrorCode];
  GPBSetInt32IvarWithFieldInternal(message, field, value, descriptor.file.syntax);
}

#pragma mark - LedgerTxs

@implementation LedgerTxs

@dynamic hasHeader, header;
@dynamic txsArray, txsArray_Count;
@dynamic ledgerLength;

typedef struct LedgerTxs__storage_ {
  uint32_t _has_storage_[1];
  LedgerHeader *header;
  NSMutableArray *txsArray;
  int64_t ledgerLength;
} LedgerTxs__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = LedgerTxs_FieldNumber_Header,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(LedgerTxs__storage_, header),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "txsArray",
        .dataTypeSpecific.className = GPBStringifySymbol(TransactionEnvResult),
        .number = LedgerTxs_FieldNumber_TxsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(LedgerTxs__storage_, txsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "ledgerLength",
        .dataTypeSpecific.className = NULL,
        .number = LedgerTxs_FieldNumber_LedgerLength,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(LedgerTxs__storage_, ledgerLength),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt64,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[LedgerTxs class]
                                     rootClass:[OverlayRoot class]
                                          file:OverlayRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(LedgerTxs__storage_)
                                         flags:0];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
...
#pragma mark - ChainContractLog

@implementation ChainContractLog

@dynamic sender;
@dynamic data_p;
@dynamic timestamp;

typedef struct ChainContractLog__storage_ {
  uint32_t _has_storage_[1];
  NSString *sender;
  NSString *data_p;
  int64_t timestamp;
} ChainContractLog__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "sender",
        .dataTypeSpecific.className = NULL,
        .number = ChainContractLog_FieldNumber_Sender,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ChainContractLog__storage_, sender),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "data_p",
        .dataTypeSpecific.className = NULL,
        .number = ChainContractLog_FieldNumber_Data_p,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(ChainContractLog__storage_, data_p),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "timestamp",
        .dataTypeSpecific.className = NULL,
        .number = ChainContractLog_FieldNumber_Timestamp,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(ChainContractLog__storage_, timestamp),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt64,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ChainContractLog class]
                                     rootClass:[OverlayRoot class]
                                          file:OverlayRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ChainContractLog__storage_)
                                         flags:0];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
