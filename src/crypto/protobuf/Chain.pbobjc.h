...
typedef GPB_ENUM(LedgerHeader_FieldNumber) {
  ...
  LedgerHeader_FieldNumber_Reserve = 10,
  LedgerHeader_FieldNumber_FeesHash = 11,
...
typedef GPB_ENUM(Operation_FieldNumber) {
  ...
  Operation_FieldNumber_ExprCondition = 4,
  Operation_FieldNumber_CreateAccount = 5,
  Operation_FieldNumber_IssueAsset = 6,
  Operation_FieldNumber_PayAsset = 7,
  Operation_FieldNumber_SetMetadata = 9,
  Operation_FieldNumber_SetSignerWeight = 10,
  Operation_FieldNumber_SetThreshold = 11,
  Operation_FieldNumber_PayCoin = 12,
  Operation_FieldNumber_Log = 13,
  Operation_FieldNumber_SetPrivilege = 14,
};
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *exprCondition;
...
typedef GPB_ENUM(OperationSetThreshold_FieldNumber) {
  ...
  OperationSetThreshold_FieldNumber_TypeThresholdsArray = 4,
};
...
typedef GPB_ENUM(Transaction_FieldNumber) {
  ...
  Transaction_FieldNumber_ExprCondition = 3,
  Transaction_FieldNumber_OperationsArray = 4,
  Transaction_FieldNumber_Metadata = 5,
  Transaction_FieldNumber_FeeLimit = 6,
  Transaction_FieldNumber_GasPrice = 7,
  Transaction_FieldNumber_CeilLedgerSeq = 8,
  Transaction_FieldNumber_ChainId = 9,
};
...
typedef GPB_ENUM(TransactionEnvStore_FieldNumber) {
  ...
  TransactionEnvStore_FieldNumber_ContractTxHashesArray = 8,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSData*> *contractTxHashesArray;
/// The number of items in @c contractTxHashesArray without causing the array to be created.
@property(nonatomic, readonly) NSUInteger contractTxHashesArray_Count;
