  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "exprCondition",
        .dataTypeSpecific.className = NULL,
        .number = Operation_FieldNumber_ExprCondition,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Operation__storage_, exprCondition),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "exprCondition",
        .dataTypeSpecific.className = NULL,
        .number = Transaction_FieldNumber_ExprCondition,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(Transaction__storage_, exprCondition),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
...
@dynamic hash_p;
@dynamic actualFee;
@dynamic contractTxHashesArray, contractTxHashesArray_Count;
...
typedef struct TransactionEnvStore__storage_ {
  ...
  NSString *errorDesc;
  NSData *hash_p;
  NSMutableArray *contractTxHashesArray;
  int64_t ledgerSeq;
  int64_t closeTime;
  int64_t actualFee;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "contractTxHashesArray",
        .dataTypeSpecific.className = NULL,
        .number = TransactionEnvStore_FieldNumber_ContractTxHashesArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(TransactionEnvStore__storage_, contractTxHashesArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeBytes,
      },
    };
