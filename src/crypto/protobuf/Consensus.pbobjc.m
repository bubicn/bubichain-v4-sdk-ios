  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "chainId",
        .dataTypeSpecific.className = NULL,
        .number = Pbft_FieldNumber_ChainId,
        .hasIndex = 8,
        .offset = (uint32_t)offsetof(Pbft__storage_, chainId),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt64,
      },
    };
...
#pragma mark - ValidatorSetV3

@implementation ValidatorSetV3

@dynamic validatorsArray, validatorsArray_Count;

typedef struct ValidatorSetV3__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *validatorsArray;
} ValidatorSetV3__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .dataTypeSpecific.className = NULL,
        .number = ValidatorSetV3_FieldNumber_ValidatorsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(ValidatorSetV3__storage_, validatorsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ValidatorSetV3 class]
                                     rootClass:[ConsensusRoot class]
                                          file:ConsensusRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ValidatorSetV3__storage_)
                                         flags:0];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
