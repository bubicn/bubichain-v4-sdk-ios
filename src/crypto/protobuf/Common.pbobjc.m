...
@dynamic newValidatorListArray, newValidatorListArray_Count;
@dynamic delValidatorsArray, delValidatorsArray_Count;
@dynamic chainId;

typedef struct LedgerUpgrade__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *newValidatorListArray;
  NSMutableArray *delValidatorsArray;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "newValidatorListArray",
        .dataTypeSpecific.className = NULL,
        .number = LedgerUpgrade_FieldNumber_NewValidatorListArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(LedgerUpgrade__storage_, newValidatorListArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "delValidatorsArray",
        .dataTypeSpecific.className = NULL,
        .number = LedgerUpgrade_FieldNumber_DelValidatorsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(LedgerUpgrade__storage_, delValidatorsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "chainId",
        .dataTypeSpecific.className = NULL,
        .number = LedgerUpgrade_FieldNumber_ChainId,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(LedgerUpgrade__storage_, chainId),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt64,
      },
    };
