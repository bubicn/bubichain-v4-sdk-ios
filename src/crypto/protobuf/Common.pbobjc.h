...
typedef GPB_ENUM(LedgerUpgrade_FieldNumber) {
  ...
  LedgerUpgrade_FieldNumber_NewValidatorListArray = 2,
  LedgerUpgrade_FieldNumber_DelValidatorsArray = 3,
  LedgerUpgrade_FieldNumber_ChainId = 4,
};
...
///for hardfork
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSString*> *newValidatorListArray NS_RETURNS_NOT_RETAINED;
/// The number of items in @c newValidatorListArray without causing the array to be created.
@property(nonatomic, readonly) NSUInteger newValidatorListArray_Count;

///for yinuo v3
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSString*> *delValidatorsArray;
/// The number of items in @c delValidatorsArray without causing the array to be created.
@property(nonatomic, readonly) NSUInteger delValidatorsArray_Count;
