...
typedef GPB_ENUM(ChainMessageType) {
  ...
  /** buchain notifies the client ledger(protocol::LedgerHeader) when closed */
  ChainMessageType_ChainLedgerHeader = 16,

  /** smart contract log */
  ChainMessageType_ChainContractLog = 17,
  ChainMessageType_ChainLedgerTxs = 18,

  /** response with CHAIN_RESPONSE */
  ChainMessageType_ChainSubscribeTx = 19,
  ChainMessageType_ChainTxEnvStore = 20,
};
...
typedef GPB_ENUM(ChainTxStatus_TxStatus) {
  ...
  ChainTxStatus_TxStatus_ApplyFailure = 5,
};
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *buchainVersion;
...
typedef GPB_ENUM(GetLedgers_FieldNumber) {
  ...
  GetLedgers_FieldNumber_ChainId = 4,
};
...
typedef GPB_ENUM(ChainStatus_FieldNumber) {
  ...
  ChainStatus_FieldNumber_BuchainVersion = 4,
  ChainStatus_FieldNumber_Timestamp = 5,
  ChainStatus_FieldNumber_NetworkId = 6,
};
...
typedef GPB_ENUM(TransactionEnvResult_FieldNumber) {
  TransactionEnvResult_FieldNumber_TranEnv = 1,
  TransactionEnvResult_FieldNumber_TxHash = 2,
  TransactionEnvResult_FieldNumber_ErrorCode = 3,
  TransactionEnvResult_FieldNumber_ErrorDesc = 4,
};

@interface TransactionEnvResult : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) TransactionEnv *tranEnv;
/** Test to see if @c tranEnv has been set. */
@property(nonatomic, readwrite) BOOL hasTranEnv;
...
/**
 * Fetches the raw value of a @c TransactionEnvResult's @c errorCode property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t TransactionEnvResult_ErrorCode_RawValue(TransactionEnvResult *message);
/**
 * Sets the raw value of an @c TransactionEnvResult's @c errorCode property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
typedef GPB_ENUM(LedgerTxs_FieldNumber) {
  LedgerTxs_FieldNumber_Header = 1,
  LedgerTxs_FieldNumber_TxsArray = 2,
  LedgerTxs_FieldNumber_LedgerLength = 3,
};

@interface LedgerTxs : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<TransactionEnvResult*> *txsArray;
...
@property(nonatomic, readwrite) int64_t ledgerLength;

@end

#pragma mark - ChainContractLog

typedef GPB_ENUM(ChainContractLog_FieldNumber) {
  ChainContractLog_FieldNumber_Sender = 1,
  ChainContractLog_FieldNumber_Data_p = 2,
  ChainContractLog_FieldNumber_Timestamp = 3,
};

@interface ChainContractLog : GPBMessage
