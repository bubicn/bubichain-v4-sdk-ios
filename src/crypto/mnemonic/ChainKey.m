...
- (ChainKey*) derivedKeychainWithPath:(NSString*)path {
...
- (ChainKey*) derivedKeychainAtIndex:(uint32_t)index hardened:(BOOL)hardened {
    ...
    ChainKey* derivedKeychain = [[ChainKey alloc] init];
