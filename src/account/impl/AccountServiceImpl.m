...
/**
 Create a new account, but it is not in bubi chain.
...
/**
 Get the info of an account that is in bubi chain.
...
/**
 Create the operation that will activate an account that is not in bubi chain
